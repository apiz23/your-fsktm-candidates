...
import nadia5 from "@/public/images/Nadia/5.jpg";
		...
		<>
			...
			>
				<div className="pt-20 md:pt-0 col-span-1 md:col-span-5 grid grid-cols-1 md:grid-cols-3 px-10 md:px-20 md:flex items-center justify-center bg-[#eb8787]">
					<h1 className="col-span-1 capitalize mx-auto text-center text-5xl lg:text-7xl w-fit md:max-w-[30vw] font-bold md:text-left tracking-wide space-y-3">
						Forward with Nadia
					</h1>
					<Separator
			...
			<div className="flex justify-center my-40">
				<SparklesText
					text="Nurul Nadia Husna binti Anuar"
					sparklesCount={20}
			...
			<div className="min-h-screen bg-slate-300 pt-32 md:px-0 px-4 md:pb-0 pb-10">
				...
				<div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 md:gap-4 gap-20">
					<div className="col-span-1">
						...
						<div className="overflow-hidden relative w-full h-[400px] md:h-[470px] rounded-lg border-4 border-black">
							<iframe
								src="https://www.instagram.com/cunerrs/embed"
					...
					<div className="col-span-1">
						...
						>
							<section>
								<Link
									target="_blank"
									href="https://www.tiktok.com/@cunerrs?refer=creator_embed"
								>
									@cunerrs
								</Link>
							</section>
